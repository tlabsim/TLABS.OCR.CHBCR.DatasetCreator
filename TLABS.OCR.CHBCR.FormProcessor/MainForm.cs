    ...
    public partial class MainForm : Form
    {
        ...
        bool ProcessFile(FileInfo file)
        {
            ...
            using (Bitmap bmp = (Bitmap)Image.FromFile(file.FullName))
            {
                ...
                BitmapProcessor bmpp = new BitmapProcessor(CurrentProcessing);
        ...
        bool StraightenAndGetBounds(out PointF tl, out PointF tr, out PointF dl, out PointF dr)
        {
            ...
            #region Initial straightening
            {
                try
                {
                    ...
                    out_xs[0] = likely_bound.Left;
                    out_xs[1] = likely_bound.Left;

                    int scan_lines = 20, max_x = likely_bound.Left * 2;
            ...
            CurrentProcessing = CurrentProcessing.Crop(this.HorizontalPageMargin + this.ScannerMarginLeft, this.VerticalPageMargin + this.ScannerMarginTop, page_width_minus_margin, page_height_minus_margin);
            ...
            #region Get bounds
            {
                ...
                // tl.X
                {
                    ...
                    if (scan_ends.Count < 10) return false;
        ...
        bool CropLetters(Rectangle roi)
        {
            ...
            try
            {
                ...
                int crop_width = (int)Math.Floor(actual_column_width) - crop_margin * 2,
                    crop_height = (int)Math.Floor(actual_row_height) - crop_margin * 2;
        ...
        void LoadConfigs()
        {
            ...
            if (this.ColumnsPerPage < 5) this.ColumnsPerPage = 5;
        ...
        double GetMean(List<int> vals)
        {
            if (vals.Count > 0)
            {
                ...
                return vals.FindAll(x => Math.Abs(mean - x) < threshold).Average();
            }
            return 0;
        }
